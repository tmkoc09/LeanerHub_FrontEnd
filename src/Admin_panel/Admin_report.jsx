...
//   Document Report
  ...
  return (
    <div>
      ...
      <div className="container px-1 px-lg-4">
            ...
            <ul class="nav nav-underline px-2 px-lg-5 gap-5 bg-white py-2 d-flex justify-content-between rounded shadow-sm" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
    <button class="nav-link active bg-white" style={{fontSize:'16px',color:tab=== "users" ? '#4880FF' : 'gray'}} id="home-tab" onClick={()=>{
      fetchdata()
      setTab("users")
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link bg-white" style={{fontSize:'16px',color:tab=== "documents" ? '#4880FF' : 'gray'}} id="home-tab2" onClick={()=>{
     setTab("documents")
   fetchdocumentdata()
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link bg-white" style={{fontSize:'16px',color:tab=== "course" ? '#4880FF' : 'gray'}} id="home-tab3" onClick={()=>{
    fetchcoursedata()
      setTab("course")
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link bg-white" style={{fontSize:'16px',color:tab=== "group" ? '#4880FF' : 'gray'}} id="profile-tab" onClick={()=>{
      fetchgroupdata()
      setTab("group")
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link bg-white" style={{fontSize:'16px',color:tab=== "flashset" ? '#4880FF' : 'gray'}} id="contact-tab" onClick={()=>{
      setTab("flashset")
      fetchflashsetdata()
...
{/* --------------------------------------------------User Report--------------------------------------------------- */}
<div class="tab-pane fade bg-white show active mt-4" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
  
  <h6 className={`text-secondary text-center py-3 ${report_details.length>0 ? 'd-none':''}`}>No user reports available.....</h6>
  <div class={` mt-4 p-3 ${report_details.length>0 ? '':'d-none'}`}>
...
{/* --------------------------------------------------Document Report--------------------------------------------------- */}
  <div class="tab-pane fade bg-white mt-4" id="home-tab-pane2" role="tabpanel" aria-labelledby="home-tab2" tabindex="0">
 ...
 <div class={`table-responsive mt-4`} style={{minHeight:'100vh'}}>
...
{/* --------------------------------------------------Course Report-------------------------------------------------- */}
<div class="tab-pane fade bg-white mt-4" id="home-tab-pane3" role="tabpanel" aria-labelledby="home-tab3" tabindex="0">
<h6 className={`text-secondary text-center py-3 ${course_report_details.length>0 ? 'd-none':''}`}>No course reports available.....</h6>

  <div class={`table-responsive mt-4 p-2 rounded ${course_report_details.length>0 ? '':'d-none'}`} style={{minHeight:'100vh'}}>
...
{/* ------------------------------------------------Group Report------------------------------------------------------ */}
  <div class="tab-pane fade bg-white mt-4" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
  <h6 className={`text-secondary text-center py-3 ${group_report_details.length>0 ? 'd-none':''}`}>No group reports available.....</h6>

  <div class={`table-responsive p-2 ${group_report_details.length>0 ? '':'d-none'}`} style={{minHeight:'100vh'}}>
  <div className='d-flex justify-content-between align-items-center py-3'>
...
{/* --------------------------------------------------Flashset Report--------------------------------------------------- */}
  <div class="tab-pane fade bg-white mt-4" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
<h6 className={`text-secondary text-center py-3 ${flashset_report_details.length>0 ? 'd-none':''}`}>No flashset reports available.....</h6>
  

  <div class={`table-responsive ${flashset_report_details.length>0 ? '':'d-none'}`} style={{minHeight:'100vh'}}>
  <div className='d-flex justify-content-between align-items-center py-3'>
