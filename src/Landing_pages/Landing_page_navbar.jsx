...
const Landing_page_navbar = ({state}) => {
  ...
  <div class="container d-flex justify-content-between">
    ...
    <svg data-bs-toggle="offcanvas" data-bs-target="#landingpage_offcanvas" aria-controls="landingpage_offcanvas" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-justify-right" viewBox="0 0 16 16">
