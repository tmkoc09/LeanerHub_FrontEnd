...
const Landing_page2 = () => {
  return (
    <div className='pb-5 pt-5 mb-5'>
        <div id="carouselExampleControlsNoTouching" style={{position:'relative'}} class="slide1 carousel slide bg-white" data-bs-touch="false">
  <div class="carousel-inner">
    <div class="carousel-item active bg-white">
      ...
      <img src={require('../img/landing_page/Group.png')} class="page2-img mt-4" alt="..."/>
       </div>
    </div>
    ...
    <p className='page2-heading m-0'>New Beginnings</p>
      ...
      <img src={require('../img/landing_page/Group (1).png')} class="page2-img mt-4" alt="..."/>
    </div>
    </div>
    <div class="carousel-item bg-white">
    <div className='d-flex flex-column align-items-center'>
    <p className='page2-heading m-0'>Essentials only!</p>
      ...
      <img src={require('../img/landing_page/Group (2).png')} class="page2-img mt-4" alt="..."/>
    </div>
    </div>
  </div>
  <button class="carousel-control-prev" style={{top:'0px',position:'absolute'}} type="button" data-bs-target="#carouselExampleControlsNoTouching" data-bs-slide="prev">
    <span class="carousel-control-prev-icon"><svg xmlns="http://www.w3.org/2000/svg" width="74" height="74" viewBox="0 0 74 74" fill="none">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControlsNoTouching" data-bs-slide="next">
    <span class="carousel-control-next-icon"><svg xmlns="http://www.w3.org/2000/svg" width="74" height="74" viewBox="0 0 74 74" fill="none">
