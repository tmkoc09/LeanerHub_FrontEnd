...
const getallStudylist=()=>{
  ...
  return (
    <div>
      ...
      <div class="offcanvas offcanvas-start"data-bs-scroll="true" tabindex="-1" id="courseOffcanvas" aria-labelledby="courseOffcanvasLabel" style={{width:'390px'}}>
  <div class="offcanvas-body p-0" >
    <div className='text-end px-2 bg-light'>
        <button className='bg-transparent border-0' data-bs-dismiss="offcanvas"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293z"/>
    ...
    <p className='m-0'>Modules ({joinedCourses.length})</p> <button className='btn btn-sm' style={{border:'1px solid #5D5FE3'}}><Link to='/courses' className='text-decoration-none' style={{color:'#5D5FE3'}}><i class="fa-solid fa-plus me-2"></i>Add Module</Link></button>
    </div>
...
{/* --------------------------------------------------GROUP OFFCANVAS FOR SMALLER SCREENS---------------------------------- */}
      <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="groupOffcanvas" aria-labelledby="groupOffcanvasLabel">
        <div class="offcanvas-body p-0 w-100">
          <div className="text-end bg-light px-2">
            <button data-bs-dismiss="offcanvas" className='bg-transparent border-0'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293z"/>
</svg></button>
          </div>
        <div>
...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="studylistcanvas" aria-labelledby="studylistcanvasLabel">
        <div class="offcanvas-body p-0 w-100">
