...
const Loginpage = ({setemailvalidation}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault();
    axios.post(`${ipaddress}/CheckEmailForThreeMonths/${userid}/`)
   .then((r)=>{
    // verifiedlogin()
  ...
  const verifiedlogin=()=>{
    ...
    const values={userid,password}
      axios.post(`${ipaddress}/UserLogin/`,values)
      .then((r)=>{
...
const forgotpassword=()=>{
  ...
  formdata.append('url','http://13.201.18.209/forgot_password/')
  ...
  return (
    <div>
        ...
        <div className="col-lg-6 d-flex align-items-center login-text mt-5 mt-lg-0 d-block d-lg-none mb-5">
...
<path d="M28.43 77.66L0 49.23L0.0700073 48.96L10.4 10.4L10.67 10.33L49.23 0L77.66 28.43L77.59 28.7L67.26 67.26L66.99 67.33L28.43 77.66ZM1.08002 48.95L28.72 76.59L66.48 66.47L76.6 28.71L48.96 1.06998L11.2 11.19L1.08002 48.95Z" fill="#5D5FE3"/>
          ...
          <div className="col-lg-6 d-flex justify-content-center align-items-center">
            ...
            <form action="" className='p-2 px-2 w-100' onSubmit={handleSubmit}>
                <div class="mb-4">
                <label for="floatingInput" style={{color:'#8E9696'}} className='mb-2'>{translate_value.login_page.email}</label>
          <input type="text" name='userid' class="form-control shadow-none bg-light" id="floatingInput" style={{height:'50px'}} onChange={useridData} value={userid}/>
        </div>
        
        <div class="mb-2">
        <label for="floatingPassword" style={{color:'#8E9696'}} className='mb-2'>{translate_value.login_page.password}</label>
          <div class="input-group mb-3 bg-light border rounded">
          <input type={password_type ? "text" : "password"} name='password' class="form-control shadow-none border-0 bg-transparent" style={{height:'50px'}} id="floatingPassword" onChange={passwordData} value={password}/>
  <span onClick={()=>{
    setPassword_type(!password_type)
  }} style={{cursor:'pointer'}}  class="input-group-text border-0 bg-transparent text-secondary" id="basic-addon2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
  ...
  <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7"/>
        ...
        {/* <Link to='/forgot_password/pattern' className='text-decoration-none mt-4 w-100 text-center' style={{fontSize:'15px',color:'#8E9696'}}><input type="checkbox" className='me-2' /> <span>By Login you <a className='fw-medium' style={{textDecoration:'underline',color:'#2A3941'}}> {translate_value.login_page.agree_to_terms}</a></span></Link> */}
          ...
          <div className="col-lg-6 d-flex align-items-center login-text mt-5 mt-lg-0 d-none d-lg-block">
...
<path d="M28.43 77.66L0 49.23L0.0700073 48.96L10.4 10.4L10.67 10.33L49.23 0L77.66 28.43L77.59 28.7L67.26 67.26L66.99 67.33L28.43 77.66ZM1.08002 48.95L28.72 76.59L66.48 66.47L76.6 28.71L48.96 1.06998L11.2 11.19L1.08002 48.95Z" fill="#5D5FE3"/>
        ...
        <div class="modal fade modal-md" id="verifyemail" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div>
              <h3 class=" fw-bold text-center fs-2 text-primary" id="staticBackdropLabel">Enter Your Email</h3>
              </div>
              <div class="modal-body">
                <form action="" className='p-2 px-4' onSubmit={verifyEmail}>
                <div class="form-floating mb-4">
          <input type="text" name='userid' class="form-control shadow-none" id="floatingInput" placeholder="name@example.com" onChange={verifyemaildata} value={email}/>
        ...
        <a href='#' className='google-Login text-decoration-none'><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/2048px-Google_%22G%22_logo.svg.png" width='30px' alt="" className='me-2'/>
        ...
        <div class="modal fade" id="otpmodal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header text-center">
                <h1 class="modal-title fs-5 mx-auto" id="exampleModalToggleLabel2">Enter the OTP</h1>
        ...
        {/* -------------------------------------------FORGOT PASSWORD-------------------------------------------------------------- */}
        <div class="modal fade modal-md" id="forgotpassword" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div className='py-3'>
              <h6 class=" fw-bold text-center fs-3 text-dark" id="staticBackdropLabel">Forgot Password</h6>
              </div>
                <form action="" className='p-2 mt-3 px-4 mb-5'>
                  <p className='text-center'>Please enter your registered email ID</p>
                <div class="form-floating mb-4">
          <input type="text" name='userid' class="form-control shadow-none" id="floatingInput" placeholder="name@example.com" onChange={(e)=>{
        ...
        <div class="modal fade modal-md" id="forgotpasswordsuccessfull" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-body pb-5">
