...
const Report_post = ({report_status,setreport_status,count,setCount,discussion_id,setindex1,disc_type}) => {
    ...
    if(disc_type==="university"){
        axios.post(`${ipaddress}/UniversityDiscussionReport/${user.user_id}/${discussion_id}/`,{
            'reason':reportreason
          })
          .then((r)=>{
    ...
    if(disc_type==="subject"){
        axios.post(`${ipaddress}/CourseDiscussionReport/${user.user_id}/${discussion_id}/`,{
            'reason':reportreason
          })
          .then((r)=>{
    ...
    if(disc_type==="group"){
        axios.post(`${ipaddress}/GroupDiscussionReport/${user.user_id}/${discussion_id}/`,{
            'reason':reportreason
          })
          .then((r)=>{
            setReportreason("")
    ...
    if(disc_type==="document"){
        axios.post(`${ipaddress}/DocumentCommentReport/${user.user_id}/${discussion_id}/`,{
            'reason':reportreason
          })
          .then((r)=>{
            setReportreason("")
