...
axios.post(`${ipaddress}/Groupflashcardsets/create/${user.user_id}/${group_id}/${semesterid}/`,formdata)
.then((r)=>{
...
.catch(()=>{
  ...
  useEffect(()=>{
    ...
    axios.get(`${ipaddress2}/Semesters/`)
    .then((p)=>{
...
const handleSubmit = async (event) => {
  ...
  try {
    ...
    const response = await axios.post(`${ipaddress2}/Add_flashcard/${flashsetId}/`, formData, {
      headers: {
    ...
    <div onClick={()=>{
        ...
        <Navbar count={count}></Navbar>
              ...
              <input type="text" name='description' className='form-control ps-4 bg-light' style={{height:'50px'}} placeholder='Description' onChange={descriptionData} value={description}/>
                ...
                <div class="col-md-6 ms-auto mb-2 mb-md-0">
                <select
                      name="scope"
                      class="form-select form-select-md px-5 ps-4 shadow-none bg-light" style={{height:'50px'}}
                      aria-label="Large select example"
