...
// -------------------------------------Add the document to the studylist category---------------------------------------
    const addtoStudylist=()=>{
        axios.post(`${ipaddress}/UserStudyListView/${user.user_id}/${document_id}/`,checkedItems)
        .then((r)=>{
...
call_function()
    ...
    <div>
        ...
        <div class="modal fade" id="studylist_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
