...
const Extracted_text = () => {
  ...
  let {translate_value,addsubjects_layout,setgroup_visible,setstudylist_visible,setcourse_visible,navbar_dropdown_visible,setnavbar_dropdown_visible}=useContext(Context)
    ...
    useEffect(()=>{
      axios.get(`${ipaddress}/DisplayDocumentText/${id}/`)
      .then((r)=>{
  ...
  return (
    <div className='d-flex'>
        ...
        <h5 className='pb-2 d-flex align-items-center' style={{color:'#5d5fe3'}}><Link to={`/showpdf/${id}`}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#5d5fe3" class="bi bi-arrow-left" viewBox="0 0 16 16">
