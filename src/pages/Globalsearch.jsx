...
const Globalsearch = () => {
  ...
  const globalsearch=(value)=>{
    if(value.length>0){
    axios.get(`${ipaddress}/DocumentSearch/${value}/${user.user_id}/`)
    .then((r)=>{
      setstatus(true)
  ...
  const joinCourse=(course_id)=>{
    axios.post(`${ipaddress}/join-course/${user.user_id}/${course_id}/`)
    .then((r)=>{
...
const navigate=useNavigate()
  ...
  return (
    <div>
<div class="offcanvas offcanvas-top" data-bs-backdrop="static" tabindex="-1"  id="searchoffcanvas" aria-labelledby="searchoffcanvasLabel" style={{height:'300px'}}>
  <div class="offcanvas-body">
    <div className='d-flex justify-content-between border-bottom pb-3 pt-2 px-1 px-lg-5 align-items-center'>
    <div class="input-group">
  <span class="input-group-text bg-white border-end-0 border-0" style={{color:'#AAB0B0'}} id="basic-addon1"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
</svg></span>
  <input type="text" class="form-control nav-input border-start-0 border-0" value={searchdata} onChange={(e)=>{
...
<svg type="button" data-bs-dismiss="offcanvas" aria-label="Close" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#FF845D" class="bi bi-x-circle" viewBox="0 0 16 16">
