...
const user=JSON.parse(sessionStorage.getItem('user'))
    useEffect(()=>{
        axios.get(`${ipaddress}/flashcardsetsRetrive/${user.user_id}/`)
        .then((r)=>{
...
const bookmarkFlashset=(flashsetId,index)=>{
    axios.post(`${ipaddress}/bookmarkflashset/${flashsetId}/${user.user_id}/`)
    .then((r)=>{
            ...
            <div className="w-100">
                <div className="container mt-5 px-5 px-lg-0">
                    ...
                    {flashset.map((x,index)=>{
                        ...
                        }}><i class={x.bookmark_status == true ? "fa-regular fa-bookmark text-warning" : "fa-regular fa-bookmark"}></i></button>
