...
const user=JSON.parse(sessionStorage.getItem("user"))
    useEffect(()=>{
      axios.get(`${ipaddress}/uploadDocuments/${user.user_id}/`)
      .then((r)=>{
    ...
    const deleteFile=(value,event)=>{
      ...
      axios.delete(`${ipaddress}/SpecificDocumentDisplay/${user.user_id}/${value}`)
      .then((r)=>{
...
const searchData=(e)=>{
  ...
  if(e.target.value.length<=0){
    ...
    axios.get(`${ipaddress}/DisplayDocumentSuggestions/${searchword}/${user.user_id}/`)
  .then((r)=>{
  ...
  .catch(()=>{
    ...
    const searchDocument=(document_name)=>{
      axios.get(`${ipaddress}/DocumentSearch/${document_name}/${user.user_id}/`)
      .then((r)=>{
  ...
  return (
    <div>
         ...
         <Mainsidebar activevalue={"documents"}></Mainsidebar>
                ...
                <div className='w-100'>
                  <div>
                  <div class="input-group common-search mx-auto mt-5" id='common-search'>
        <input
        onChange={searchData}
        value={search}
          type="search"
          class="home-search form-control w-75 form-control mx-auto outline-0 shadow-none py-3 ps-4"
          placeholder="Document Search...."
          aria-label="Recipient's username"
          aria-describedby="basic-addon2" style={{borderRadius:'0px  0px 0px 0px'}}
        />
        {/* <button onClick={searchDocument} class="input-group-text fw-bold bg-transparent px-3 " id="basic-addon2" style={{borderRadius:'0px 0px 0px 0px'}}>
      ...
      <ul className="view-doc ps-0" style={{ listStyleType: 'none' }}>
                    {searchDocs.map((x, index) => {
                      ...
                      >
                        ...
                        <li>
                          <a href="" className='text-secondary text-decoration-none' style={{fontSize:"13px"}}><i class="fa-solid fa-calendar-days me-1"></i>{x.created_on}</a>
                          </li>
                          <li className=''>
                          <a href="" className='text-secondary text-decoration-none' style={{fontSize:"13px"}}><i class="fa-solid fa-file-lines me-1"></i>{x.pages}</a>
                          </li>
                          <li className=''>
                          <a href="" className='text-secondary text-decoration-none' style={{fontSize:"13px"}}><i class="fa-regular fa-star me-1"></i>{x.average_rating>0 ? `${x.average_rating}` : '0'}</a>
                          </li>
                          <li className=''>
                          <a href="" className='text-secondary text-decoration-none' style={{fontSize:"13px"}}><i class="fa-regular fa-thumbs-up me-1"></i>{x.followers_count}</a>
                          </li>
                         
                        </ul>
                        {/* <a href="" className='text-secondary text-decoration-none' style={{fontSize:"13px"}}><i class="fa-solid fa-graduation-cap me-1"></i>Course</a> */}
                        ...
                        <a type='button' id="liveToastBtn" href="" onClick={()=>{
      ...
      {userDocuments.map((x, index) => {
                      ...
                      >
                        ...
                        <li>
                          ...
                          <li className=''>
                          <a href="" className='text-secondary text-decoration-none' style={{fontSize:"13px"}}><i class="fa-regular fa-thumbs-up me-1"></i>{x.favourites_count}</a>
