...
const Groups = () => {
 ...
 formdata.append('group_name',groupname)
    ...
    await axios.post(`http://192.168.0.106:9000/ParticularUserGroup/${user.user_id}/`,formdata)
    .then((r)=>{
...
toastBootstrap.show()
  ...
  useEffect(()=>{
    axios.get(`http://192.168.0.106:9000/ParticularUserGroup/${user.user_id}/`)
    .then((r)=>{
...
if(value.length==10){
  // console.log(value)
  axios.get(`http://192.168.0.106:9000/SearchGroup/${user.user_id}/${value}/`)
  .then((r)=>{
    // console.log(r.data)
...
const sendGroupID=()=>{
  axios.post(`http://192.168.0.106:9000/SearchGroup/${user.user_id}/${searchGroup}/`)
  .then((r)=>{
...
const deleteGroup=(group_id)=>{
  axios.delete(`http://192.168.0.106:9000/GroupDelete/${group_id}/`)
  .then((r)=>{
