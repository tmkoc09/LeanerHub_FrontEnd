...
const fetchdocuments=()=>{
  setsubloading(true)
  axios.get(`${ipaddress}/courseDocuments/${course_id}/${userdata.user_id}/`)
  .then((r)=>{
...
const fetchcoursedetails=()=>{
  axios.get(`${ipaddress}/CourseDetailsView/${course_id}/${userdata.user_id}/`)
    .then((r)=>{
...
const getallflashsetsundersubject=()=>{   
  setsubloading(true)
axios.get(`${ipaddress2}/flashcardsetsRetrive/${course_id}/${userdata.user_id}/`)
    .then((r)=>{
...
const getparticularusersflashsets=()=>{   
  setsubloading(true)
  axios.get(`${ipaddress2}/myflashset/${userdata.user_id}/${course_id}/`)
      .then((r)=>{
...
const postQuestion = async (e) => {
  ...
  if(question.length>0){
    try {
      const response = await fetch(`${ipaddress}/CourseDiscussion/${user.user_id}/${course_id}/${question}/`, {
        method: 'POST',
        body: formData,
      });
...
const postReplies= async (dis_id,index)=>{
  ...
  const formData = new FormData();
        ...
        if(replies.length>0){
          try {
            const response = await fetch(`${ipaddress}/CourseDiscussionReply/${user.user_id}/${dis_id}/${replies}/`, {
                method: 'POST',
                body: formData,
            });
...
const postreply_for_replies= async ()=>{
  ...
  const formData = new FormData();
    ...
    if(reply_for_reply.length>0){
      try {
        const response = await fetch(`${ipaddress}/CourseDiscussionRepliesReply/${user.user_id}/${reply_id}/${reply_for_reply}/`, {
            method: 'POST',
            body: formData,
        });
...
const getdiscussion=()=>{
  const user=JSON.parse(sessionStorage.getItem('user'))
  axios.get(`${ipaddress}/ocoursediscussion/${user.user_id}/${course_id}/`)
  .then((r)=>{
...
const leaveCourse=()=>{
const user=JSON.parse(sessionStorage.getItem('user'))
axios.post(`${ipaddress}/ExitGroup/${user.user_id}/${course_id}/`,{
...
function handleLike1(discussion_id) {
 axios.delete(`${ipaddress}/DiscussionLikes/${userdata.user_id}/${discussion_id}/`)
 .then((r)=>{
...
function handleLike(discussion_id) {
  axios.post(`${ipaddress}/DiscussionLikes/${userdata.user_id}/${discussion_id}/`)
  .then((r)=>{
...
function handleReplyLike1(discussion_id,discid,index) {
  axios.delete(`${ipaddress}/DiscussionRepliesLikes/${userdata.user_id}/${discussion_id}/`)
  .then((r)=>{
 ...
 function handleReplyLike(discussion_id,discid,index) {
   axios.post(`${ipaddress}/DiscussionRepliesLikes/${userdata.user_id}/${discussion_id}/`)
   .then((r)=>{
...
function handledislike(discussion_id) {
  axios.post(`${ipaddress}/CourseDiscussionDisLike/${userdata.user_id}/${discussion_id}/`)
  .then((r)=>{
...
function handlereplydislike(discussion_id,discid,index) {
  axios.post(`${ipaddress}/CourseDiscussionRepliesDisLikes/${userdata.user_id}/${discussion_id}/`)
  .then((r)=>{
   console.log("User Disliked the Post",r.data)
   getreplies(discid,index)
  })
...
function handleReplies_reply_like(replies_reply_id,disc_replyid) {
  axios.post(`${ipaddress}/CourseDiscussionRepliesReplyLikes/${userdata.user_id}/${replies_reply_id}/`)
  .then((r)=>{
...
function handlereplies_replydislike(replies_reply_id,disc_replyid) {
  axios.post(`${ipaddress}/CourseDiscussionRepliesReplyDislike/${userdata.user_id}/${replies_reply_id}/`)
  .then((r)=>{
...
const sendEditedData =() => {
  ...
  axios.put(`${ipaddress}/CourseDiscussionEdit/${userdata.user_id}/${course_id}/${discussionId}/`,formData)
 .then((r)=>{
  setCount(count+1)
...
const getreplies=(discussion_id,index)=>{
  axios.get(`${ipaddress}/coursecommentsreplies/${discussion_id}/${userdata.user_id}/`)
  .then((r)=>{
...
const getreplies_for_reply=(particular_reply_id)=>{
  axios.get(`${ipaddress}/CourseDiscussionRepliesReply/${userdata.user_id}/${particular_reply_id}/`)
  .then((r)=>{
...
const deletePost=(discussion_id)=>{
  axios.delete(`${ipaddress}/CDDI/${discussion_id}/`)
  .then((r)=>{
    setCount(count+1)
...
const deleteReply=(disc_reply_id,discid)=>{
  axios.delete(`${ipaddress}/CourseDiscussionReplydelete/${disc_reply_id}/`)
  .then((r)=>{
    setCount(count+1)
...
const deleteReply_for_reply=(reply_reply_id,disc_reply_id,discid)=>{
  axios.delete(`${ipaddress}/CourseDiscussionRepliesReply/${userdata.user_id}/${reply_reply_id}/`)
  .then((r)=>{
...
const filterfunction2=(category,value)=>{
  axios.post(`${ipaddress}/DocumentsBasedOnCategory/${userdata.user_id}/${category}/${course_id}/`,{
    'sort_by':value
  })
    .then((r)=>{
...
const filterflashsets=(value)=>{
  if(value==="likes"){
  axios.post(`${ipaddress2}/FlashsetsFilters/${userdata.user_id}/${course_id}/`,{
    'like':true,
    'datetime':false})
  .then((r)=>{
    console.log("Liked")
...
const filterpublicflashsets=(value)=>{
  if(value==="likes"){
  axios.post(`${ipaddress2}/PublicFlashsetsFilters/${userdata.user_id}/${course_id}/`,{
    'like':true,
    'datetime':false})
  .then((r)=>{
    console.log("Liked")
...
const searchDocuments=(value)=>{
  if(value.length>0){
  axios.post(`${ipaddress}/SearchCourseFlashcardsAndDocumentsUnderCourse/${userdata.user_id}/${course_id}/${value}/`)
  .then((r)=>{
...
const searchFlashset=(value)=>{
  if(value.length>0){
  axios.get(`${ipaddress2}/SearchFlashsetsCourse/${userdata.user_id}/${course_id}/${value}/`)
  .then((r)=>{
...
const searchpublicFlashset=(value)=>{
  if(value.length>0){
  axios.get(`${ipaddress2}/SearchPublicFlashsets/${userdata.user_id}/${course_id}/${value}/`)
  .then((r)=>{
...
axios.post(`${ipaddress}/coursediscussionpinningview/${userdata.user_id}/${course_id}/`,formdata)
.then((r)=>{
...
const reportCourse=()=>{
  ...
  axios.post(`${ipaddress}/CourseReport/${userdata.user_id}/${course_id}/`,report)
  .then((r)=>{
...
const unsave=(doc_id)=>{
  axios.delete(`${ipaddress}/UserStudyListView/${userdata.user_id}/${doc_id}/`)
  .then((r)=>{
...
const unsave_flashset=(flashset_id)=>{
  axios.put(`${ipaddress2}/Unsave_flashcard_studylist/${userdata.user_id}/${flashset_id}/`)
  .then((r)=>{
...
axios.delete(`${ipaddress}/Unpiningcoursecomments/${userdata.user_id}/${course_id}/${discid}/`)
.then((r)=>{
...
<div>
<button className='p-1 border-0 bg-transparent' data-bs-toggle="modal" data-bs-target="#leavecourse"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="#5D60E1" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
...
<ul class={`${reportdropdownstate ? '':'d-none'} rounded me-5 bg-white border-0 py-2 mt-3 px-2 ps-3 report-dropdown`} style={{width:'180px',listStyleType:'none',position:'absolute'}}>
<li className={`${courseDetails.course_report_status ? 'd-none':''}`}><a data-bs-toggle="modal" data-bs-target="#reportsubjectmodal" class="dropdown-item d-flex align-items-center" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-octagon" viewBox="0 0 16 16">
<path d="M4.54.146A.5.5 0 0 1 4.893 0h6.214a.5.5 0 0 1 .353.146l4.394 4.394a.5.5 0 0 1 .146.353v6.214a.5.5 0 0 1-.146.353l-4.394 4.394a.5.5 0 0 1-.353.146H4.893a.5.5 0 0 1-.353-.146L.146 11.46A.5.5 0 0 1 0 11.107V4.893a.5.5 0 0 1 .146-.353zM5.1 1 1 5.1v5.8L5.1 15h5.8l4.1-4.1V5.1L10.9 1z"/>
<path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0M7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0z"/>
</svg> <span className='ms-2'>Report Irrelevant</span></a></li>
<li className={`mt-2 ${courseDetails.course_report_status ? 'd-none':''}`}><a data-bs-toggle="modal" data-bs-target="#reportsubjectmodal" class="dropdown-item d-flex align-items-center" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bug" viewBox="0 0 16 16">
...
{/* ----------------------------------------------------DISCUSSION AND DOCUMENT LAYOUT--------------------------------- */}
            ...
            setreportdropdownstate(false)
                      ...
                      <ul class="nav nav-underline gap-2 w-100 w-md-50" id="myTab" role="tablist">
<li class="nav-item" role="presentation">
  ...
  <button class="nav-link p-2 bg-white fw-normal" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false" style={{color:tablist ==="documents" ? '#5D5FE3':'#8E9696',fontSize:'16px'}} onClick={()=>{
    setTablist("documents")
    fetchdocuments()
  }}>Documents ({courseDetails.docuemnts_count})</button>
</li>
<li class="nav-item" role="presentation">
  <button class="nav-link p-2 bg-white fw-normal" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false" style={{color:tablist ==="flashcards" ? '#5D5FE3':'#8E9696',fontSize:'16px'}}
  onClick={()=>{
...
<div className='w-100 ps-0 ps-md-3 mt-3 mt-md-0 w-md-50'>
  {/* ------------------------------------------------Document Search bar-------------------------------------------- */}
<div class={`input-group bg-light rounded border ${tablist==="documents" ? '':'d-none'}`}>
...
<input type="text" class="form-control bg-transparent border-0 ps-0 sub-search" placeholder={translate_value.common_words.search} onChange={(e)=>{
  searchDocuments(e.target.value)
}} aria-label="Username" aria-describedby="basic-addon1" style={{fontSize:'14px'}}/>
</div>

{/* --------------------------------------------------Flashcards Search bar------------------------------------------- */}
<div class={`input-group bg-light rounded border ${tablist==="flashcards" && flashsetstatus==="myflashcards" ? '':'d-none'}`}>
<span class="input-group-text bg-transparent border-0" id="basic-addon1"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
<path d="M20.2965 20.9936L13.774 14.4712C13.2532 14.9145 12.6542 15.2577 11.9771 15.5008C11.3001 15.7439 10.6196 15.8654 9.93586 15.8654C8.26746 15.8654 6.85544 15.2879 5.6998 14.1329C4.54414 12.9778 3.96631 11.5666 3.96631 9.89908C3.96631 8.23158 4.54382 6.81924 5.69883 5.66205C6.85385 4.50486 8.26511 3.92627 9.93261 3.92627C11.6001 3.92627 13.0125 4.50409 14.1696 5.65973C15.3268 6.81538 15.9054 8.22741 15.9054 9.89583C15.9054 10.6196 15.7772 11.3201 15.5208 11.9972C15.2644 12.6743 14.9279 13.2532 14.5112 13.734L21.0336 20.2564L20.2965 20.9936ZM9.93586 14.8237C11.3181 14.8237 12.485 14.348 13.4365 13.3964C14.388 12.4449 14.8638 11.278 14.8638 9.89583C14.8638 8.51362 14.388 7.34676 13.4365 6.39523C12.485 5.4437 11.3181 4.96794 9.93586 4.96794C8.55366 4.96794 7.38679 5.4437 6.43527 6.39523C5.48376 7.34676 5.008 8.51362 5.008 9.89583C5.008 11.278 5.48376 12.4449 6.43527 13.3964C7.38679 14.348 8.55366 14.8237 9.93586 14.8237Z" fill="#8E9696"/>
</svg></span>
<input type="text" value={searchflashsetname} class="form-control border-0 ps-0 sub-search bg-transparent" placeholder={translate_value.common_words.flashset} onChange={(e)=>{
  setsearchflashsetname(e.target.value)
  searchFlashset(e.target.value)
}} aria-label="Username" aria-describedby="basic-addon1" style={{fontSize:'14px'}}/>
</div>

<div class={`input-group bg-light rounded border ${tablist==="flashcards" && flashsetstatus==="public" ? '':'d-none'}`}>
<span class="input-group-text bg-transparent border-0" id="basic-addon1"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
<path d="M20.2965 20.9936L13.774 14.4712C13.2532 14.9145 12.6542 15.2577 11.9771 15.5008C11.3001 15.7439 10.6196 15.8654 9.93586 15.8654C8.26746 15.8654 6.85544 15.2879 5.6998 14.1329C4.54414 12.9778 3.96631 11.5666 3.96631 9.89908C3.96631 8.23158 4.54382 6.81924 5.69883 5.66205C6.85385 4.50486 8.26511 3.92627 9.93261 3.92627C11.6001 3.92627 13.0125 4.50409 14.1696 5.65973C15.3268 6.81538 15.9054 8.22741 15.9054 9.89583C15.9054 10.6196 15.7772 11.3201 15.5208 11.9972C15.2644 12.6743 14.9279 13.2532 14.5112 13.734L21.0336 20.2564L20.2965 20.9936ZM9.93586 14.8237C11.3181 14.8237 12.485 14.348 13.4365 13.3964C14.388 12.4449 14.8638 11.278 14.8638 9.89583C14.8638 8.51362 14.388 7.34676 13.4365 6.39523C12.485 5.4437 11.3181 4.96794 9.93586 4.96794C8.55366 4.96794 7.38679 5.4437 6.43527 6.39523C5.48376 7.34676 5.008 8.51362 5.008 9.89583C5.008 11.278 5.48376 12.4449 6.43527 13.3964C7.38679 14.348 8.55366 14.8237 9.93586 14.8237Z" fill="#8E9696"/>
</svg></span>
<input type="text" value={searchflashsetname} class="form-control border-0 ps-0 sub-search bg-transparent" placeholder={translate_value.common_words.flashset} onChange={(e)=>{
...
<div class="tab-pane fade show active bg-white py-1 px-0 px-md-3 mt-3" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
 ...
 <button className="btn btn-sm d-flex align-items-center px-3 border-end-0 fs-6 px-5 px-md-3" style={{borderRadius:'5px 0px 0px 5px', border:'1px solid #5D5FE7',color:usercomment_status==false && pinnedcomment_status==false ? '#fff':'#5D5FE7',height:'36px',backgroundColor:usercomment_status==false && pinnedcomment_status==false ? '#5d5fe3':'#fff'}} onClick={()=>{
      ...
      }}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-left d-inline d-md-none" viewBox="0 0 16 16">
 ...
 <button className="btn btn-sm d-flex align-items-center px-3 border-end-0 fs-6 px-5 px-md-3" style={{borderRadius:'0px 0px 0px 0px',border:'1px solid #5D5FE7',color:'#5D5FE7',height:'36px',color:usercomment_status==false && pinnedcomment_status==true ? '#fff':'#5D5FE7',height:'36px',backgroundColor:usercomment_status==false && pinnedcomment_status==true ? '#5d5fe3':'#fff'}} onClick={()=>{
      ...
      }}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pin d-inline d-md-none" viewBox="0 0 16 16">
...
<span className='d-flex align-items-center'>
      <button className='btn btn-sm d-flex align-items-center justify-content-center px-3 fs-6 px-5 px-md-3' style={{borderRadius:'0px 5px 5px 0px',border:'1px solid #5D5FE7',color:'#5D5FE7',height:'36px',color:'#5D5FE7',height:'36px',color:usercomment_status==true && pinnedcomment_status==false ? '#fff':'#5D5FE7',height:'36px',backgroundColor:usercomment_status==true && pinnedcomment_status==false ? '#5d5fe3':'#fff'}} onClick={()=>{
        ...
        setpinnedcomment_status(false)
        setoriginal_status(false)
      }}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill d-inline d-md-none" viewBox="0 0 16 16">
...
<input type="text" value={searchcomment} class="form-control bg-transparent border-0 ps-0 sub-search" placeholder={translate_value.common_words.search_discussion}
      onChange={(e)=>{
        ...
        {userdetails.nickname!=undefined ? (<p className={userdetails.profile_pic ==null ? 'd-flex justify-content-center align-items-center bg-warning text-white rounded-circle my-auto' : 'd-none'} style={{height:'40px',width:'40px'}}><span>{userdetails.nickname.slice(0,1)}</span><span>{userdetails.nickname.slice(-1)}</span></p>):(<></>)}
          <div class="input-group bg-light border rounded pe-3">
                <input
                  ...
                  // value={editedpost}
                  class="form-control py-3 ps-3 bg-light border-0 shadow-none post-input" placeholder="Post your Comment....."
...
<path d="M13.6825 16.4231C13.6825 18.3164 13.0302 19.9276 11.7258 21.2565C10.4213 22.5855 8.8259 23.25 6.9397 23.25C5.05347 23.25 3.4541 22.5855 2.1416 21.2565C0.829102 19.9276 0.172852 18.3164 0.172852 16.4231V5.50962C0.172852 4.1875 0.62758 3.0637 1.53704 2.13822C2.4465 1.21274 3.56229 0.75 4.88441 0.75C6.20652 0.75 7.3223 1.21274 8.23176 2.13822C9.14122 3.0637 9.59595 4.1875 9.59595 5.50962V15.8462C9.59595 16.5801 9.33986 17.2123 8.82769 17.7428C8.31553 18.2732 7.69133 18.5385 6.9551 18.5385C6.21887 18.5385 5.58553 18.2774 5.05507 17.7552C4.52461 17.2331 4.25938 16.5967 4.25938 15.8462V5.46153H5.50941V15.8462C5.50941 16.2452 5.64603 16.5853 5.91926 16.8666C6.19249 17.1478 6.52862 17.2885 6.92766 17.2885C7.32671 17.2885 7.66284 17.1478 7.93607 16.8666C8.20932 16.5853 8.34595 16.2452 8.34595 15.8462V5.48556C8.34113 4.51442 8.00725 3.69071 7.34429 3.01444C6.68135 2.33815 5.86139 2 4.88441 2C3.91519 2 3.09595 2.34215 2.4267 3.02644C1.75747 3.71073 1.42285 4.53846 1.42285 5.50962V16.4231C1.41806 17.9663 1.95252 19.2816 3.02623 20.369C4.09996 21.4563 5.40734 22 6.94838 22C8.46774 22 9.75918 21.4563 10.8227 20.369C11.8863 19.2816 12.4229 17.9663 12.4325 16.4231V5.46153H13.6825V16.4231Z" fill="#8E9696"/>
                ...
                <button disabled={isLoading} data-bs-dismiss="modal" onClick={postQuestion} className='text-secondary h-100 bg-transparent border-0 ms-2 outline-0' ><span className={isLoading ? "spinner-border spinner-border-sm" : ""} aria-hidden="true"></span><i class={isLoading ? '' : "fa-solid fa-paper-plane"}></i></button>
                </div>
              </div>
  ...
  <p className={x.user_details.profile_pic ==null ? 'd-flex justify-content-center align-items-center bg-warning text-white rounded-circle my-auto' : 'd-none'} style={{height:'40px',width:'40px'}}><span>{x.user_details.nickname.slice(0,1)}</span><span>{x.user_details.nickname.slice(-1)}</span></p>
          ...
          <div className={`col-8 p-0 ${x.pinned_status ? 'col-md-8':'col-md-9'}`} onClick={()=>{
            ...
            <span className='fw-normal ms-2 text-secondary' style={{fontSize:'13px'}}>{x.created_at}</span>
              ...
              <p className='ms-3 ms-sm-0 my-0' style={{fontSize:'12px',color:'#8587EA'}}>{course_name}</p>
          </div>
          <div className={`col-3 ps-4 d-flex justify-content-between align-items-center p-0 ${x.pinned_status ? 'col-md-3':'col-md-2'}`}>
          <button onClick={()=>{
            unpin(x.discid)
...
<div class="modal fade" id="deletecomment" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<div class="modal fade" id="originaleditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-lg">
  <div class="modal-content">
    <div class="modal-body">
      <div className=' bg-white px-3 pt-2 pb-3 rounded'>
        ...
        {userdetails.nickname!=undefined ? (<p className={userdetails.profile_pic ==null ? 'd-flex justify-content-center align-items-center bg-warning text-white rounded-circle my-auto' : 'd-none'} style={{height:'40px',width:'40px'}}><span>{userdetails.nickname.slice(0,1)}</span><span>{userdetails.nickname.slice(-1)}</span></p>):(<></>)}
          ...
          }} className='text-info bg-transparent border-0'><i class="fa-solid fa-paper-plane"></i></button>
        </div>
      </div>
      </div>
  </div>
...
>
<span className={isLoading1 ? "spinner-border spinner-border-sm" : ""} aria-hidden="true"></span>
<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
<path d="M5 23.125V6.875L24.2789 15L5 23.125ZM6.25 21.25L21.0625 15L6.25 8.75V13.6058L12.3077 15L6.25 16.3942V21.25Z" fill="#8E9696"/>
                ...
                <div class="modal fade" id="RepliesModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
    <div class="modal-body">
      ...
      <input
              ...
              <label
                htmlFor='file'
                class="custom-file-input rounded-pill border-0 bg-primary bg-gradient text-white px-4 py-2"
              >Upload Image</label>
      </div>
    </div>
  </div>
...
<div class="tab-pane fade bg-light mt-2" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
...
<button data-bs-toggle="modal" data-bs-target="#studylist_modal" className={`bg-transparent border-0 ${x.study_list_status ? 'd-none':''}`} style={{color:'#8587EA'}} onClick={()=>{
  ...
  <path d="M7.50016 11.2261L3.81425 7.54021L4.55144 6.79102L6.97933 9.21891V0.208496H8.021V9.21891L10.4489 6.79102L11.1861 7.54021L7.50016 11.2261ZM1.89118 14.7918C1.41175 14.7918 1.01145 14.6312 0.690267 14.3101C0.369086 13.9889 0.208496 13.5886 0.208496 13.1091V10.5851H1.25016V13.1091C1.25016 13.2694 1.31693 13.4163 1.45048 13.5498C1.58403 13.6834 1.73094 13.7502 1.89118 13.7502H13.1091C13.2694 13.7502 13.4163 13.6834 13.5498 13.5498C13.6834 13.4163 13.7502 13.2694 13.7502 13.1091V10.5851H14.7918V13.1091C14.7918 13.5886 14.6312 13.9889 14.3101 14.3101C13.9889 14.6312 13.5886 14.7918 13.1091 14.7918H1.89118Z" fill="#8E9696"/>
                        ...
                        <span  style={{fontSize:'14px',color:'#AAB0B0'}} className='ms-3 d-flex align-items-center'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
...
<span style={{fontSize:'14px',color:'#AAB0B0'}}  className={`ms-3 d-none d-md-flex align-items-center`}><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-tags" viewBox="0 0 16 16">
...
<button data-bs-toggle="modal" data-bs-target="#studylist_modal" onClick={()=>{
  ...
  <div className="m-0 d-flex align-items-center mt-2">
        ...
        <span data-bs-toggle="tooltip" data-bs-placement="bottom"
        data-bs-custom-class="custom-tooltip"
        data-bs-title="Likes" style={{fontSize:'14px',color:'#AAB0B0'}} className='ms-3 d-flex align-items-center'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
      ...
      <span data-bs-toggle="tooltip" data-bs-placement="bottom"
        data-bs-custom-class="custom-tooltip"
        data-bs-title="Likes" style={{fontSize:'14px',color:'#AAB0B0'}} className='ms-3 d-flex align-items-center'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
...
<div class="modal fade" id="leavecourse" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
{/* ---------------------------------------------Report subject--------------------------------------------------- */}
<div class="modal fade" id="reportsubjectmodal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog modal-md">
  <div class="modal-content">
    <div class="modal-body pt-4 pb-3">
      <div>
