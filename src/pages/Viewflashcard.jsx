...
const likeFlashset=()=>{
  axios.post(`${ipaddress2}/flashsetlikes/${user.user_id}/${flashset_id}/`)
  .then((r)=>{
...
axios.post(`${ipaddress2}/BookmarkFlashcard/${user.user_id}/${flashcardId}/`)
.then((r)=>{
...
const deleteFlashcard=(flashcardId)=>{
  axios.post(`${ipaddress2}/Delete_flashcard/`,{
...
const reportCourse=()=>{
  ...
  axios.post(`${ipaddress2}/FlashsetReport/`,report)
  .then((r)=>{
...
const dislikeFlashset=()=>{
  axios.post(`${ipaddress2}/FlashsetDislikeView/${user.user_id}/${flashset_id}/`)
  .then((r)=>{
...
const changeScope=()=>{
  axios.post(`${ipaddress2}/Change_scope/`,{
...
<ul class={`${reportdropdownstate ? '':'d-none'} rounded me-5 bg-white border-0 py-2 mt-3 px-2 ps-3 report-dropdown`} style={{width:'180px',listStyleType:'none',position:'absolute',right:'40px',top:'115px'}}>
<li><a data-bs-toggle="modal" data-bs-target="#reportflashsetmodal" class={`dropdown-item d-flex align-items-center ${Flashset.Flashsetreport_status ? 'd-none':''}`} href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-octagon" viewBox="0 0 16 16">
<path d="M4.54.146A.5.5 0 0 1 4.893 0h6.214a.5.5 0 0 1 .353.146l4.394 4.394a.5.5 0 0 1 .146.353v6.214a.5.5 0 0 1-.146.353l-4.394 4.394a.5.5 0 0 1-.353.146H4.893a.5.5 0 0 1-.353-.146L.146 11.46A.5.5 0 0 1 0 11.107V4.893a.5.5 0 0 1 .146-.353zM5.1 1 1 5.1v5.8L5.1 15h5.8l4.1-4.1V5.1L10.9 1z"/>
<path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0M7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0z"/>
</svg> <span className='ms-2'>Report Irrelevant</span></a></li>

<li className='mt-2'><a data-bs-toggle="modal" data-bs-target="#reportflashsetmodal" class={`dropdown-item d-flex align-items-center ${Flashset.Flashsetreport_status ? 'd-none':''}`} href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bug" viewBox="0 0 16 16">
...
<li className={`${Flashset.Flashsetreport_status ? '':'d-none'}`} style={{color:'#ff845d'}}><a class="dropdown-item d-flex align-items-center" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bug" viewBox="0 0 16 16">
<path d="M4.355.522a.5.5 0 0 1 .623.333l.291.956A5 5 0 0 1 8 1c1.007 0 1.946.298 2.731.811l.29-.956a.5.5 0 1 1 .957.29l-.41 1.352A5 5 0 0 1 13 6h.5a.5.5 0 0 0 .5-.5V5a.5.5 0 0 1 1 0v.5A1.5 1.5 0 0 1 13.5 7H13v1h1.5a.5.5 0 0 1 0 1H13v1h.5a1.5 1.5 0 0 1 1.5 1.5v.5a.5.5 0 1 1-1 0v-.5a.5.5 0 0 0-.5-.5H13a5 5 0 0 1-10 0h-.5a.5.5 0 0 0-.5.5v.5a.5.5 0 1 1-1 0v-.5A1.5 1.5 0 0 1 2.5 10H3V9H1.5a.5.5 0 0 1 0-1H3V7h-.5A1.5 1.5 0 0 1 1 5.5V5a.5.5 0 0 1 1 0v.5a.5.5 0 0 0 .5.5H3c0-1.364.547-2.601 1.432-3.503l-.41-1.352a.5.5 0 0 1 .333-.623M4 7v4a4 4 0 0 0 3.5 3.97V7zm4.5 0v7.97A4 4 0 0 0 12 11V7zM12 6a4 4 0 0 0-1.334-2.982A3.98 3.98 0 0 0 8 2a3.98 3.98 0 0 0-2.667 1.018A4 4 0 0 0 4 6z"/>
</svg> <span className='ms-2'>Already Reported</span></a></li>
</ul>
</div>

<span className='ms-4 ps-2'><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="#5D5FE3" class="bi bi-share" viewBox="0 0 16 16">
...
<div class="modal fade" id="viewdescription" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<button data-bs-toggle="modal" data-bs-target="#flashcard_studylist_modal" className={`fw-medium btn ${Flashset.studylist_status ? 'd-none':''}`} style={{border:'1px solid #5d5fe3',fontSize:'14px',color:'#5d5fe3',backgroundColor:'#fff'}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark" viewBox="0 0 16 16">
  ...
  <button onClick={()=>{
    unsave()
  }} className={`fw-medium btn ${Flashset.studylist_status ? '':'d-none'}`} style={{border:'1px solid #5d5fe3',fontSize:'14px',color:'#fff',backgroundColor:'#5d5fe3'}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark" viewBox="0 0 16 16">
  <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1z"/>
                  ...
                  Flashset.flashcards_data.map((x)=>{
                    return(
                      <div className="row border bg-white m-0 mt-3 rounded">
                          ...
                          <div className="col-md-2 d-flex justify-content-end py-4  align-items-center">
                            <button className='border-0 bg-transparent' onClick={()=>{
                              likeFlashcard(x.flashcard_id)
                            }}>
                            <i class={x.bookmark_status ? "fa-solid fa-bookmark":"fa-regular fa-bookmark"} style={{color:x.bookmark_status ? "#ff855f":""}}></i>
                            </button>
...
<div className='bg-white w-50 rounded py-3 px-3 mx-auto mt-3'>
          <p className='m-0 mb-2 ms-3'>Are you surely want to change the scope to public?</p>
...
<div class="modal fade" id="reportflashsetmodal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
