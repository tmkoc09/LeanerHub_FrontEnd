  ...
  return (
   <div>
    {loading ? (<Preloader/>) : (
       ...
       <nav className="container navbar p-3  fixed-top">
         <div className="d-flex justify-content-between w-100">
           ...
           <a href="#" className={emailvalidation==true ? "home-link fw-normal fs-6 text-decoration-none p-2 px-3  text-center rounded-pill d-block" : "d-none"} 
            ...
            <i class="fa-solid fa-key me-1"></i> Login
             </Link>
       ...
       <div class="input-group pe-0 pe-sm-5 mb-5 px-sm-4">
         <input
           type="search"
           class="home-search form-control form-control mx-auto outline-0  shadow-none py-3 border-end-0 ps-4"
           placeholder="Search...."
           aria-label="Recipient's username"
           aria-describedby="basic-addon2" style={{borderRadius:'30px 0px 0px 30px'}}
         />
         <span class="input-group-text fw-bold bg-white border-start-0 px-3" id="basic-addon2" style={{borderRadius:'0px 30px 30px 0px'}}>
